...
// =======================================================
// 🟢 Student Profile Badge Design (PRACTICE + EXAM RANKS)
// =======================================================
let myExamRank = null;
let myExamData = null;
...
// 🟢 নতুন নিরাপদ পপআপ ফাংশন (যাতে কোড স্ক্রিনে না ভেসে ওঠে)
window.showExamBadgeDetails = function(rank, examName, score, total, percentage) {
    Swal.fire({
        title: '<span style="font-size: 20px;">Exam Champion! 🏆</span>',
        html: `
            <div style="font-size:14px; color:var(--text-main); line-height:1.5;">
                You secured <b style="color:var(--primary); font-size:16px;">Rank #${rank}</b> in<br>
                <b style="color:#d97706;">${examName}</b>!<br><br>
                <div style="background: rgba(16, 185, 129, 0.1); border: 1px dashed #10b981; padding: 8px; border-radius: 8px; color: #047857; font-weight: bold; display: inline-block;">
...
if (rank && myExamRank) {
    // 🟢 স্টুডেন্ট যদি প্র্যাকটিস এবং এক্সাম দুটিতেই টপ র‍্যাংক করে
    let safeExamName = globalData.published_exam_ranking.examName ? globalData.published_exam_ranking.examName.replace(/'/g, "\\'") : 'Exam';
    let examClick = `window.showExamBadgeDetails(${myExamRank}, '${safeExamName}', ${myExamData.score}, ${myExamData.total}, ${myExamData.percentage})`;
